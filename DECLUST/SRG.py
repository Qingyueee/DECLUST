...
def srg_process(dbscan_centers_df, coords, st_highly_variable_genes_df, neighbours_rules):
    ...
    # duplicates = label_df.index.duplicated()
    # if duplicates.any():
    #     print("There are duplicate row indices.")
    #     print("Duplicate row indices are:")
    #     print(label_df[duplicates])
    # else:
    #     print("There are no duplicate row indices.")
